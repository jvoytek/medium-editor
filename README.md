...
* __insertBrOnReturn__:  enables/disables the use of the return-key to add a br instead of a paragraph (disableReturn overrides this option). You can also set specific element behavior by using setting a data-insert-br-on-return attribute. Default: `false`
